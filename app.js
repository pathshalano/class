...
hi:{login:'लॉगिन',logout:'लॉगआउट',back:'वापस',save:'सेव',home:'होम',all:'सभी',birthday:'जन्मदिन',overview:'अवलोकन',language:'भाषा'},
no:{login:'Logg inn',logout:'Logg ut',back:'Tilbake',save:'Lagre',home:'Hjem',all:'Alle',birthday:'Bursdag',overview:'Oversikt',language:'Språk'}};
